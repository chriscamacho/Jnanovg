...
public class nvg {
    ...
    public static class Paint {
		...
		Paint imagePattern(long ctx, float ox, float oy, float ex, float ey,
		...
		Paint linearGradient(long ctx, float sx, float sy, float ex, float ey, 
		...
		Paint boxGradient(long ctx, float x, float y, float w, float h,
		...
		Paint radialGradient(long ctx, float cx, float cy, float inr, float outr, Color icol, Color ocol)
		{
    ...
    public static class Color {
		...
		void setRed(float r) { buff.put(0,r); }
		void setGreen(float g) { buff.put(1,g); }
		void setBlue(float b) { buff.put(2,b); }
		void setAlpha(float a) { buff.put(3,a); }
